export default function postValidate(req, res, next) {
  const { title, image_url, category_id, description, content, status_id } = req.body;

  const errors = {};
  
  if (!title) errors.title = "Title is required.";
  if (!image_url) errors.image_url = "image_url is required.";
  ...
  if (image_url && typeof image_url !== "string") errors.image_url = "image_url must be a string.";
